...
public class Pokerito {
	...
	public static void main(String[] args) {
		...
		System.out.println(" Now dealer will draw five cards. press enter to continue \n");
		for (int i = 1; i < 5; i++) {
			String dealerCards=randomCard();
			System.out.println("card "+i+"\n"+dealerCards);
			if (userCard.equalsIgnoreCase(dealerCards)) {
				userMatches++;
			}
			else if (computerCard.equalsIgnoreCase(dealerCards)) {
				computerMatches++;
			} 
		...
		if (computerMatches>userMatches) {
			...
			System.out.println(" ties! both are winners.");
		}
